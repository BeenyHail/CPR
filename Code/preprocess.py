...
def SaveMethoad(objList, pdf):
    ...
    if numstr.startswith(b'314'): #MAC
    ...
    elif numstr.startswith(b'1013'): #HanPDF version 1.4
        ...
        elif b"/Type/Catalog/" in objList[0][2] and b"/Type/Pages>>" in objList[1][2]: #version 1.6 - French
            pdf['SaveMethod'] = "HanPDF"
        elif b"/Type/Pages/>>" in objList[0][2] or b"<</Filter/FlateDecode" in objList[1][2]: #version 1.7 - Korean, English
            pdf['SaveMethod'] = "HanPDF"
...
def Image_extract(Pdf_Path, objList, PdfOutputPath, imagename):
    ...
    # Step1: Collect base image → smask_num mapping (preprocessing to extract only one correct PNG)
    smask_map = {}
    for i in objList:
        obj_str = i[2]
        obj_num = int(i[0])
    ...
    for i in objList:
        ...
        if obj_num in smask_map.values(): # Skip SMask objects
            continue
        ...
        if b'/Subtype /Image' in obj_str or b'/Subtype/Image' in obj_str:
            try:
                ...
                image_ext = base_image["ext"]  # Find extension
                ...
                if b'/SMask' in obj_str or b'/Mask' in obj_str:
                    ...
                    try:
                        ...
                        # Use imagename if available, otherwise use object number
                        ...
                        print(f"Error processing SMask object {smask_num}: {e}")
                ...
                print(f"Error extracting image (object {obj_num}): {e}")
                try: # Attempt forced JPEG extraction
                    image_data = None
